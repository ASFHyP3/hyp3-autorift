...
def process(reference: str, secondary: str, parameter_file: str = DEFAULT_PARAMETER_FILE,
    ...
    if platform == 'S1':
        ...
        print(f'generateAutoriftProduct(\n'
              f'    {reference_path}, {secondary_path}, nc_sensor={platform}, optical_flag=False, ncname=None,'
              f'    geogrid_run_info={geogrid_info}, {parameter_info["autorift"]},'
              f'    parameter_file={DEFAULT_PARAMETER_FILE.replace("/vsicurl/", "")},'
              f')')

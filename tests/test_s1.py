...
def test_get_s1_primary_polarization():
    assert (
        s1_isce2.get_s1_primary_polarization('S1B_WV_SLC__1SSV_20200923T184541_20200923T185150_023506_02CA71_AABB')
        == 'vv'
    )
    assert (
        s1_isce2.get_s1_primary_polarization('S1B_IW_GRDH_1SDV_20200924T092954_20200924T093026_023515_02CABC_6C62')
        == 'vv'
    )
    assert (
        s1_isce2.get_s1_primary_polarization('S1B_IW_GRDH_1SSH_20200924T112903_20200924T112932_023516_02CAC7_D003')
        == 'hh'
    )
    assert (
        s1_isce2.get_s1_primary_polarization('S1B_IW_OCN__2SDH_20200924T090450_20200924T090519_023515_02CAB8_917B')
        == 'hh'
    )
